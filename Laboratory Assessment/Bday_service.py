...
def send_whatsappImage(data):
    name = data[0]
    number = '+91'+data[2]
    img ="C:\\Users\\Tanvi\\OneDrive\\Desktop\\Laboratory Assessment\\bday.jpg"
...
def send_EmailImage(data):
    ...
    sender_mail = "palkartanvi216@gmail.com"
...
'''def send_text(num):
    ...
    number = '+91'+str(num)
    accoount_sid =  'AC77b42cf305357d2e5706e1e6a4f3dde5'
    auth_token = 'f9e372da65100f8f6d90ae80d9a81374'
    client = Client(accoount_sid,auth_token)
    message = client.messages.create(
    body = "hii! \n Wish you a hppiest birthday!" +"\n from - Tanvi Palkar",
        from_ = "+13029247753",
        to = number
        )
    print("Text Send!")
